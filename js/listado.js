...
const eliminarDuplicados = arr => (Array.from(new Set(arr)).sort());
...
Listado.prototype.obtenerUbicaciones = function () {
    ...
    var armarArray = elem => arrayUbicaciones.push(elem.ubicacion)

    this.restaurantes.map(armarArray);
    
    return eliminarDuplicados(arrayUbicaciones);
...
Listado.prototype.obtenerRubros = function () {
    ...
    var armarArray = elem => arrayRubros.push(elem.rubro)
...
Listado.prototype.obtenerHorarios = function () {
    ...
    var armarArray = elem => arrayDeArraysHorarios.push(elem.horarios)

    this.restaurantes.map(armarArray);

    arrayDeArraysHorarios.forEach(arr => arr.forEach(horario => arrayHorarios.push(horario)));
